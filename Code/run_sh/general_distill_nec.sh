...
SUPERNET_DIR=/home/dsi/dxu/Backups/Research_Server/Working/MSR/output_debug_KDNAS/
...
CUDA_VISIBLE_DEVICES=2,0,3 nohup python -u -m torch.distributed.launch --nproc_per_node=3 run_wiki_NoAssist_RndSampl.py --pregenerated_data $CORPUS_JSON \
                          --model_type bert \
                          --task_name $TASK_NAME \
                          --do_train \
                          --data_dir $TASK_DIR \
