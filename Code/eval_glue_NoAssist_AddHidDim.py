...
from transformers import (BertConfig,
                                  BertForSequenceClassification, BertForSequenceClassification_v1, BertForSequenceClassification_v1_AddHidLoss, BertTokenizer,
                                  RobertaConfig,
...
def main():
    ...
    parser.add_argument('--hidden_mult', type=str, default='1.',
                        help="the possible hid_embed used for training, e.g., '1.' is for default")
