...
def train(args, train_dataset, model, tokenizer, teacher_model=None):
    ...
    # epoch_training = 0
    for epoch_training in train_iterator:

        if args.local_rank != -1:
            train_dataloader.sampler.set_epoch(epoch_training)
                        ...
                        for intermediate_mult in sorted(args.intermediate_mult_list, reverse=True):
                            ...
                            if args.local_rank != -1:
                                ...
                                if global_step % 500 == 0:
                                    print("After all_reduce - Epoch {}, Step {}, Local_rank {}, Loss {}".format(epoch_training, step, args.local_rank, loss))
                                    print('')
