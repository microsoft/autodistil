...
from transformers import (BertConfig, BertForSequenceClassification, BertForSequenceClassification_v1_AddHidLoss, BertForPreTraining, BertForPreTraining_v1_Primer, BertTokenizer,
                                  RobertaConfig,
...
MODEL_CLASSES = {
    ...
    'bert': (BertConfig, BertForPreTraining_v1_Primer, BertTokenizer),
