...
from .data import (is_sklearn_available,
                   ...
                   glue_output_modes, glue_convert_examples_to_features, glue_convert_examples_to_features_transferset,
...
if is_torch_available():
    ...
    from .modeling_bert import (BertPreTrainedModel, BertModel, BertModel_v1,
